          ...
          <?php echo form_open('admin/updateConfig', array('class' => 'form-horizontal')); ?>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-append">
                    <input type="text" name="login_timeout" value="<?php echo $config['login_timeout'];?>">
		    <span class="add-on">minute<?php if($config['login_timeout'] > 1)echo "s";?></span>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type='text' name='base_url' value="<?php echo $config['base_url'];?>" />
             ...
             <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-append">
                    <input type="text" name="captcha_length" value="<?php echo $config['captcha_length'];?>">
		    <span class="add-on">character<?php if($config['captcha_length'] > 1) echo "s"; ?></span>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type='text' name='index_page' value="<?php echo $config['index_page'];?>" />
		...
		<div class='controls'>
		  <?php echo anchor('admin/category/add', 'Add Category', 'class="btn"');?>
		  <?php echo anchor('admin/category/remove', 'Remove Category', 'class="btn"');?>
		</div>
	      </div>
