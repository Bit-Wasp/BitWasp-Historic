          ...
          <div class="container-fluid">
            <div class="row-fluid">
              <div class="span9 btn-group">
                <?=anchor('messages/send/'.$user['userHash'],'Message this user', 'class="btn"');?>
              </div>
            </div>
            ...
            <div class="row-fluid">
              ...
              <div class="span8 well"><?=$profileMessage;?></div>
            </div>
            <?php } ?>
              ...
              <div class="row-fluid">
                ...
                <pre id="publicKeyBox" class="span8 well"><?=$user['publicKey']?></pre>
              </div>
			      <?php } ?>
