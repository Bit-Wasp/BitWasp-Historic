...
INSERT INTO `bw_config` (`id`, `jsonConfig`) VALUES
(1, '{"site_title":"Bitwasp :: Anonymous Online Marketplace","login_timeout":"60","base_url":"http:\\/\\/localhost\\/bitwasp","index_page":"index.php","default_items_per_page":"25"}');
...
--
-- Dumping data for table `bw_messageBuddies`
--
...
--
-- Dumping data for table `bw_messages`
--
-- --------------------------------------------------------
